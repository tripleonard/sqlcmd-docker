...
dm_name="unixODBC 2.3.1 DriverManager"
dm_dir="unixODBC-2.3.1"
dm_package='unixODBC-2.3.1.tar.gz'
...
function print_usage
{
    ...
    echo "  --download-url=url | file:// - Specify the location (and name) of $dm_package."
    echo "       For example, if $dm_package is in the current directory, specify "
    echo "       --download-url=file://$dm_package."
